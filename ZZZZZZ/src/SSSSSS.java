...
for(int i=0;i<ele.size();i++)
{
	...
	for(int i =0;i<take.size();i++)
	{
		...
		driver = new ChromeDriver();	
driver.get("file:///C:/Users/dkunal/Desktop/hidden%20element/hidden.html");
 driver.findElement(By.xpath("//*[@name='firstname']")).sendKeys("dhfh");
 List<WebElement> ele =driver.findElements(By.xpath("//*[@name='firstname']"));
 int x = ele.size();
 System.out.println(x);
 driver.findElements(By.xpath("//*[@name='firstname']")).get(x-1).sendKeys("hbhfbre");
    ScreenShot.Screen(driver, "abcd");
